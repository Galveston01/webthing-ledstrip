...
bool AsyncWebServerRequest::_parseReqHead(){
  ...
  if(m == "GET"){
    _method = ANOTHER_HTTP_GET;
  } else if(m == "POST"){
    _method = ANOTHER_HTTP_POST;
  } else if(m == "DELETE"){
    _method = ANOTHER_HTTP_DELETE;
  } else if(m == "PUT"){
    _method = ANOTHER_HTTP_PUT;
  } else if(m == "PATCH"){
    _method = ANOTHER_HTTP_PATCH;
  } else if(m == "HEAD"){
    _method = ANOTHER_HTTP_HEAD;
  } else if(m == "OPTIONS"){
    _method = ANOTHER_HTTP_OPTIONS;
  }
...
const char * AsyncWebServerRequest::methodToString() const {
  if(_method == ANOTHER_HTTP_ANY) return "ANY";
  else if(_method & ANOTHER_HTTP_GET) return "GET";
  else if(_method & ANOTHER_HTTP_POST) return "POST";
  else if(_method & ANOTHER_HTTP_DELETE) return "DELETE";
  else if(_method & ANOTHER_HTTP_PUT) return "PUT";
  else if(_method & ANOTHER_HTTP_PATCH) return "PATCH";
  else if(_method & ANOTHER_HTTP_HEAD) return "HEAD";
  else if(_method & ANOTHER_HTTP_OPTIONS) return "OPTIONS";
  return "UNKNOWN";
}
