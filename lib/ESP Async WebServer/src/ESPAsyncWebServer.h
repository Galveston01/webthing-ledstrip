...
#ifndef WEBSERVER_H
typedef enum {
  ANOTHER_HTTP_GET     = 0b00000001,
  ANOTHER_HTTP_POST    = 0b00000010,
  ANOTHER_HTTP_DELETE  = 0b00000100,
  ANOTHER_HTTP_PUT     = 0b00001000,
  ANOTHER_HTTP_PATCH   = 0b00010000,
  ANOTHER_HTTP_HEAD    = 0b00100000,
  ANOTHER_HTTP_OPTIONS = 0b01000000,
  ANOTHER_HTTP_ANY     = 0b01111111,
} WebRequestMethod;
#endif
