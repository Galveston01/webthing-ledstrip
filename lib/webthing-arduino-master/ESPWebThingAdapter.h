...
public:
  ...
  void begin() {
    ...
    this->server.on("/*", ANOTHER_HTTP_OPTIONS,
                    std::bind(&WebThingAdapter::handleOptions, this,
                              std::placeholders::_1));
    this->server.on("/", ANOTHER_HTTP_GET,
    ...
    while (device != nullptr) {
      ...
      while (property != nullptr) {
        ...
        this->server.on(propertyBase.c_str(), ANOTHER_HTTP_GET,
                        std::bind(&WebThingAdapter::handleThingPropertyGet,
                                  this, std::placeholders::_1, property));
        this->server.on(propertyBase.c_str(), ANOTHER_HTTP_PUT,
      ...
      while (action != nullptr) {
        ...
        this->server.on(actionBase.c_str(), ANOTHER_HTTP_GET,
                        std::bind(&WebThingAdapter::handleThingActionGet, this,
                                  std::placeholders::_1, device, action));
        this->server.on(actionBase.c_str(), ANOTHER_HTTP_POST,
                        ...
                        std::bind(&WebThingAdapter::handleBody, this,
                                  ...
                                  std::placeholders::_3, std::placeholders::_4,
                                  std::placeholders::_5));
        this->server.on(actionBase.c_str(), ANOTHER_HTTP_DELETE,
      ...
      this->server.on((deviceBase + "/actions").c_str(), ANOTHER_HTTP_POST,
                      ...
                      std::bind(&WebThingAdapter::handleBody, this,
                                ...
                                std::placeholders::_3, std::placeholders::_4,
                                std::placeholders::_5));
      this->server.on((deviceBase + "/events").c_str(), ANOTHER_HTTP_GET,
                      std::bind(&WebThingAdapter::handleThingEventsGet, this,
                                std::placeholders::_1, device));
      this->server.on(deviceBase.c_str(), ANOTHER_HTTP_GET,
